...
def generate_ioc_stream_docx(report_data: dict[str, Any], output_path: str) -> str:
    ...
    metrics = [
        ...
        ("IoCs inside selected window", collection.get("local_inside_window_count", collection.get("iocs_inside_window", summary.get("iocs_inside_window", collection.get("raw_ioc_count", 0))))),
        ...
        ("Local inside window count", collection.get("local_inside_window_count", 0)),
        ("Local outside window count", collection.get("local_outside_window_count", 0)),
        ("Earliest outside window timestamp", collection.get("earliest_outside_window_timestamp") or "n/a"),
        ("Latest outside window timestamp", collection.get("latest_outside_window_timestamp") or "n/a"),
        ("Time-window filtering applied", collection.get("time_window_filtering_applied", "n/a")),
